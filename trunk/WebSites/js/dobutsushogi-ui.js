    ...
    function _updateBoard(candidate) {
        ...
        switch (candidate.type) {
            ...
            case AICandidateType.place:
                ...
                break;
            default:
                _error("fatal error at _updateBoard [Unexpected candidate type ({0})]", candidate.type);
                break;
        }
