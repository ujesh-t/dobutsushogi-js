...
AIEngine.prototype = {
    ...
    negaMax: function (board, depth, outCandidate) {
        ...
        for (var i = 0; i < candidates.length; i++) {
            ...
            var e;
            setTimeout(function () {
                e = -self.negaMax(candidates[i].nextBoard, depth - 1, null);
                if (maxVal < e) {
                    maxVal = e;
    ...
    negaAlphaBeta: function (board, depth, alpha, beta, outCandidate) {
        ...
        for (var i = 0; i < candidates.length; i++) {
            ...
            var breakFlag = false;
            next(function () {
                e = -this.negaAlphaBeta(candidates[i].nextBoard, depth - 1, -beta, -alpha, null);
            }).next(function () {
                if (maxVal < e) {
                    maxVal = e;
                    if (alpha < e) {
